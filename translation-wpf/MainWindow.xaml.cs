namespace MicrosoftSpeechSDKSamples.WpfTranslationSample
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private void InitializeVoiceMap()
        {
            ...
            voiceMap.Add("pl-PL", "Microsoft Server Speech Text to Speech Voice (pl-PL, PaulinaRUS)");
        ...
        private async void StartButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                Start();
                this._startButton.Content = "_Stop Translation";
            }

            else
            {
                this._startButton.Content = "_Start Translation";
                _startButton.Background = System.Windows.SystemColors.MenuBarBrush;
        ...
        private async void Start()
        {
            ...
            {
                this.SubscriptionKey = "d63dea8502494a7ba8382de81f4e25bc";
            }
            ...
            this.ToLanguages.Add(((ComboBoxItem)voiceComboBox.SelectedItem).Tag.ToString());
            ...
            if (!this.started)
            {
                ...
                _startButton.Background = new SolidColorBrush(Colors.LimeGreen);
                this.started = true;
        ...
        {  
            ...
            {      
                    crisLogText.Dispatcher.Invoke(new Action(() =>
                    {
                        if (this.crisLogText.LineCount > 18)
                            this.crisLogText.Clear();
                    }));


                string text = string.Empty;

                noSource.Dispatcher.Invoke(new Action(() =>
                {
                    if (noSource.IsChecked == false)
                    {
                        text = e.Result.Text;
                ...
                //crisLogText.Dispatcher.Invoke(new Action(() =>
                //{
                //    crisLogText.Foreground = new SolidColorBrush(Colors.Yellow);                    
                //}));
        ...
        private void _mainWindow_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            {
                this.crisLogText.Width = e.NewSize.Width;
                this.crisLogText.Height = e.NewSize.Height;
            }
        }
    }
}
